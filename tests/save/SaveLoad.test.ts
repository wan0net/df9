...
describe('save validation', () => {
  ...
  it('validates every nested callback payload and identifier', () => {
    ...
    save.characters = [{
      ...
      nHairVariation: 85,
      nBottomAccessoryVariation: 1_000_001,
      nTopAccessoryVariation: 1_000_001,
    ...
    const invalidMutations: ((candidate: SaveData) => void)[] = [
      ...
      candidate => { candidate.characters[0].nBodyVariation = 1_000_002; },
      candidate => { candidate.characters[0].sPortrait = 'x'.repeat(257); },
