...
export const GOAL_DEFS: GoalDef[] = [
  ...
  goal('BuiltEverything', 'GOALSS005TEXT', 'GOALSS006TEXT', 'builtEverything', 44),
  ...
  goal('AllTechs', 'GOALSS019TEXT', 'GOALSS020TEXT', 'allTechs', 20),
  ...
  goal('AllPossessions', 'GOALSS025TEXT', 'GOALSS026TEXT', 'allPossessions', 30),
