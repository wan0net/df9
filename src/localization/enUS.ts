...
76. Please send help. Factory hiveworld near rim of Wah-toh-Gua space. Landing coordinates encrypted in instructions for FONHGE model smoothie maker. Hurry.`,
  ...
  // ── Settings Panel (from original Lua MainGame_enUS.lua) ──────────
  SETMENU01TEXT: `SETTINGS`,
  SETMENU02TEXT: `MUSIC VOLUME`,
  SETMENU03TEXT: `SFX VOLUME`,
  SETMENU04TEXT: `AUTOSAVE`,
  SETMENU06TEXT: `FULLSCREEN`,
  SETMENU07TEXT: `COLORBLIND MODE (Requires restart)`,

  // ── Derelict System ───────────────────────────────────────────────
  DERELICT_DISCOVERY: `A derelict ship has been discovered nearby.`,
  DERELICT_HOSTILES: `The derelict is infested with hostiles!`,
  DERELICT_SURVIVORS: `Survivors detected aboard the derelict!`,
  DERELICT_VALUABLE: `Sensors indicate valuable cargo aboard the derelict.`,
  DERELICT_TRAP: `Warning! The derelict appears to be booby-trapped!`,
  DERELICT_PARASITES: `Parasite infestation detected aboard the derelict!`,
  DERELICT_FAILURE: `The derelict has suffered catastrophic system failure.`,
  DERELICT_CHOICE_LOOT: `Loot the wreck`,
  DERELICT_CHOICE_LEAVE: `Leave it alone`,
  DERELICT_CHOICE_FIGHT: `Engage the hostiles`,
  DERELICT_CHOICE_RETREAT: `Retreat immediately`,
  DERELICT_CHOICE_RESCUE: `Rescue the survivors`,
  DERELICT_CHOICE_IGNORE: `Ignore them`,
  DERELICT_CHOICE_SECURE: `Secure the cargo`,
  DERELICT_CHOICE_MARK: `Mark for later`,
  DERELICT_CHOICE_DISARM: `Attempt to disarm`,
  DERELICT_CHOICE_FLEE: `Flee the ship`,
  DERELICT_CHOICE_EXTERMINATE: `Exterminate the parasites`,
  DERELICT_CHOICE_QUARANTINE: `Quarantine the ship`,
  DERELICT_CHOICE_SALVAGE: `Salvage what we can`,
  DERELICT_CHOICE_ABANDON: `Abandon the wreck`,
  DERELICT_LOOTED: `Salvaged matter from the wreck.`,
  DERELICT_COMBAT_WON: `Combat successful! Hostiles eliminated.`,
  DERELICT_COMBAT_LOST: `Combat failed. Retreating with losses.`,
  DERELICT_RESCUED: `Successfully rescued survivors!`,
  DERELICT_SECURED: `Cargo secured!`,
  DERELICT_DISARMED: `Trap disarmed successfully!`,
  DERELICT_DISARM_FAILED: `Disarm attempt failed! Trap triggered!`,
  DERELICT_FLED: `Escaped the derelict.`,
  DERELICT_PARASITES_CLEARED: `Parasite infestation eliminated!`,
  DERELICT_PARASITES_FAILED: `Failed to contain the parasites!`,
  DERELICT_QUARANTINED: `Ship quarantined to prevent spread.`,
  DERELICT_SALVAGED: `Salvaged matter from the wreck.`,

  // ── Docking System ────────────────────────────────────────────────
  IMMIGRATION_SHUTTLE: `Immigration Shuttle`,
  RAIDER_SHIP: `Raider Vessel`,
  ALERT_TRADER_ARRIVED: `A trader has arrived!`,
  ALERT_IMMIGRATION_ARRIVED: `New immigrants have arrived!`,
  ALERT_RAIDER_ARRIVED: `A raider ship is attacking!`,
  ALERT_TRADER_DEPARTED: `The trader has departed.`,
  ALERT_IMMIGRATION_DEPARTED: `The immigration shuttle has departed.`,
