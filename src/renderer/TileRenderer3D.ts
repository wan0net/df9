...
const WALL_TRIM_BY_SUFFIX: Record<string, { trimX: number; trimY: number }> = {
  ...
  '_Corner_lb_bottom':       { trimX: 0, trimY: 0 },
  '_Corner_rb_bottom':       { trimX: 0, trimY: 0 },
  '_Corner_T_NE_bottom':     { trimX: 0, trimY: 0 },
  '_Corner_T_NW_bottom':     { trimX: 0, trimY: 0 },
  '_Corner_T_SE_bottom':     { trimX: 0, trimY: 0 },
  '_Corner_T_SW_bottom':     { trimX: 0, trimY: 0 },
  '_Corner_cross_bottom':    { trimX: 0, trimY: 0 },
  '_Straight01_top':         { trimX: 0, trimY: 0 },
  '_Corner_outer01_top':     { trimX: 0, trimY: 0 },
  '_Corner_inner01_top':     { trimX: 0, trimY: 0 },
  '_Corner_lb_top':          { trimX: 0, trimY: 0 },
  '_Corner_rb_top':          { trimX: 0, trimY: 0 },
  '_Corner_T_NE_top':        { trimX: 0, trimY: 0 },
  '_Corner_T_NW_top':        { trimX: 0, trimY: 0 },
  '_Corner_T_SE_top':        { trimX: 0, trimY: 0 },
  '_Corner_T_SW_top':        { trimX: 0, trimY: 0 },
  '_Corner_cross_top':       { trimX: 0, trimY: 0 },
};

const DOOR_TRIM: Record<string, { trimX: number; trimY: number }> = {
  'tile_door_closed':         { trimX: 0, trimY: 0 },
  'tile_door_open':           { trimX: 0, trimY: 0 },
  'tile_door_locked':         { trimX: 0, trimY: 0 },
  'tile_door_broken':         { trimX: 0, trimY: 0 },
  'tile_heavy_door_closed':   { trimX: 0, trimY: 0 },
  'tile_heavy_door_locked':   { trimX: 0, trimY: 0 },
  'tile_airlock_door_closed': { trimX: 0, trimY: 0 },
  'tile_airlock_door_open':   { trimX: 0, trimY: 0 },
  'tile_airlock_door_broken': { trimX: 0, trimY: 0 },
};
