/**
 * PlayGameSystem.ts — Play at a game system (arcade machine).
 * Mirrors Lua OptionData: Needs={Amusement=6}.
 */

import { Task, type NeedAdvertisement } from '../Task';
import { MORALE_DID_HOBBY } from '../../characters/CharacterConstants';

export class PlayGameSystem extends Task {
  readonly name = 'PlayGameSystem';
  nJobExperience = 0;
