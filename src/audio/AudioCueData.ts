...
export const AUDIO_CUES: Record<string, AudioCue> = {
  ...
  UI_Select:        { path: 'ui/NewSelect_1.wav',          volume: 0.8, loop: false, category: 'ui', spatial: false,
                      variants: ['ui/NewSelect_1.wav', 'ui/NewSelect_2.wav', 'ui/NewSelect_3.wav', 'ui/NewSelect_4.wav', 'ui/NewSelect_5.wav'] },
  ...
  UI_Hilight:       { path: 'ui/UI_Hilight1.wav',          volume: 0.4, loop: false, category: 'ui', spatial: false,
                      variants: ['ui/UI_Hilight1.wav', 'ui/UI_Hilight2.wav', 'ui/UI_Hilight3.wav', 'ui/UI_Hilight4.wav'] },
  ...
  MeteorImpact:     { path: 'sfx/MeteorExplode1.wav',            volume: 1.0, loop: false, category: 'sfx', spatial: true,
                      variants: ['sfx/MeteorExplode1.wav', 'sfx/MeteorExplode2.wav', 'sfx/MeteorExplode3.wav'] },
  SpaceSuitEquip:   { path: 'sfx/SpaceSuitEquip1.wav',           volume: 0.8, loop: false, category: 'sfx', spatial: true,
                      variants: ['sfx/SpaceSuitEquip1.wav', 'sfx/SpaceSuitEquip2.wav'] },
  ...
  OutofBed:         { path: 'sfx/OutofBed_1.wav',                volume: 0.5, loop: false, category: 'sfx', spatial: true,
                      variants: ['sfx/OutofBed_1.wav', 'sfx/OutofBed_2.wav', 'sfx/OutofBed_3.wav', 'sfx/OutofBed_4.wav', 'sfx/OutofBed_5.wav'] },
  ...
  PowerDown:        { path: 'sfx/Spacebase_PowerDown_A.wav',     volume: 0.7, loop: false, category: 'sfx', spatial: false,
                      variants: ['sfx/Spacebase_PowerDown_A.wav', 'sfx/Spacebase_PowerDown_B.wav'] },
  PowerUp:          { path: 'sfx/Spacebase_PowerUp_A.wav',       volume: 0.7, loop: false, category: 'sfx', spatial: false,
                      variants: ['sfx/Spacebase_PowerUp_A.wav', 'sfx/Spacebase_PowerUp_B.wav'] },
  ...
  TurretFire:       { path: 'sfx/Spacebase_TurretGuns_Fire_A.wav', volume: 0.8, loop: false, category: 'sfx', spatial: true,
                      variants: ['sfx/Spacebase_TurretGuns_Fire_A.wav', 'sfx/Spacebase_TurretGuns_Fire_B.wav',
                                 'sfx/Spacebase_TurretGuns_Fire_C.wav', 'sfx/Spacebase_TurretGuns_Fire_D.wav',
                                 'sfx/Spacebase_TurretGuns_Fire_E.wav', 'sfx/Spacebase_TurretGuns_Fire_F.wav',
                                 'sfx/Spacebase_TurretGuns_Fire_G.wav', 'sfx/Spacebase_TurretGuns_Fire_H.wav',
                                 'sfx/Spacebase_TurretGuns_Fire_I.wav', 'sfx/Spacebase_TurretGuns_Fire_J.wav',
                                 'sfx/Spacebase_TurretGuns_Fire_K.wav'] },
  TurretRotate:     { path: 'sfx/Spacebase_TurretGuns_Rotate_A.wav', volume: 0.5, loop: false, category: 'sfx', spatial: true,
                      variants: ['sfx/Spacebase_TurretGuns_Rotate_A.wav', 'sfx/Spacebase_TurretGuns_Rotate_B.wav',
                                 'sfx/Spacebase_TurretGuns_Rotate_C.wav', 'sfx/Spacebase_TurretGuns_Rotate_D.wav',
                                 'sfx/Spacebase_TurretGuns_Rotate_E.wav'] },
  ...
  Laser_Impact:     { path: 'ambience/Spacebase_Laserlmpact_A.wav', volume: 0.9, loop: false, category: 'sfx', spatial: true,
                      variants: ['ambience/Spacebase_Laserlmpact_A.wav', 'ambience/Spacebase_Laserlmpact_B.wav',
                                 'ambience/Spacebase_Laserlmpact_C.wav', 'ambience/Spacebase_Laserlmpact_D.wav',
                                 'ambience/Spacebase_Laserlmpact_E.wav', 'ambience/Spacebase_Laserlmpact_F.wav',
                                 'ambience/Spacebase_Laserlmpact_G.wav', 'ambience/Spacebase_Laserlmpact_H.wav',
                                 'ambience/Spacebase_Laserlmpact_I.wav'] },
  Taser_Impact:     { path: 'ambience/Spacebase_Taserlmpact_A.wav', volume: 0.7, loop: false, category: 'sfx', spatial: true,
                      variants: ['ambience/Spacebase_Taserlmpact_A.wav', 'ambience/Spacebase_Taserlmpact_B.wav',
                                 'ambience/Spacebase_Taserlmpact_C.wav', 'ambience/Spacebase_Taserlmpact_D.wav',
                                 'ambience/Spacebase_Taserlmpact_E.wav'] },
  Citizen_Drink:    { path: 'sfx/Citizen_Drink1.wav',             volume: 0.5, loop: false, category: 'sfx', spatial: true,
                      variants: ['sfx/Citizen_Drink1.wav', 'sfx/Citizen_Drink2.wav'] },
  ...
  BadAlien_Attack:  { path: 'sfx/Spacebase_BadAlien_Attack_A.wav', volume: 0.8, loop: false, category: 'sfx', spatial: true,
                      variants: ['sfx/Spacebase_BadAlien_Attack_A.wav', 'sfx/Spacebase_BadAlien_Attack_B.wav',
                                 'sfx/Spacebase_BadAlien_Attack_C.wav', 'sfx/Spacebase_BadAlien_Attack_D.wav',
                                 'sfx/Spacebase_BadAlien_Attack_E.wav', 'sfx/Spacebase_BadAlien_Attack_F.wav'] },
